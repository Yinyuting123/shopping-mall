  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{userDafaultAddress.fullAddress || ''}}</span>
        收货人：<span>{{userDafaultAddress.consignee}} </span>
        <span>{{userDafaultAddress.phoneNum}}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
      ...
      async submitOrder() {
          ...
          let data = {
              consignee: this.tradeInfo.consignee,
              consigneeTel: this.userDafaultAddress.phoneNum,
              deliveryAddress: this.userDafaultAddress.fullAddress,
              paymentWay: 'ONLINE',
