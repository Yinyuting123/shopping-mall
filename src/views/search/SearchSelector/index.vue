  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="trademark in trademarkList" :key="trademark.tmId" @click="selectTrademark(trademark)">{{ trademark.tmName }}</li>
    ...
    <div class="type-wrap" v-for="attrs in attrsList" :key="attrs.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(item, index) in attrs.attrValueList" 
            :key="index" 
            @click="selectProps(attrs, item)">
            <a>{{ item }}</a>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    selectProps(attrs, item) {
      let props = `${attrs.attrId}:${item}:${attrs.attrName}`
      this.$emit('propsInfo', props);
    }
  },
};
</script>
