            ...
            <div class="chooseArea">
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  :key="attrValue.id"
                  :class="{ choosed: attrValue.isChecked === '1' }"
                  @click="
                    changeChoose(attrValue, spuSaleAttr.spuSaleAttrValueList)
                  "
                >
...
export default {
  ...
  methods: {
    ...
    // 属性切换高亮
    changeChoose(attrValue, spuSaleAttrValueList) {
